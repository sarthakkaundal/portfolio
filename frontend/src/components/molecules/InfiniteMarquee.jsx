...
const InfiniteMarquee = ({ text }) => {
  return (
    <div className="relative w-full overflow-hidden flex bg-background/80 backdrop-blur-md py-6 border-y border-glassBorder transform -rotate-3 scale-110 my-10 z-20 shadow-2xl">
